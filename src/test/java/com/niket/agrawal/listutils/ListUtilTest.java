package com.niket.agrawal.listutils;
...
import com.agrawal.niket.listutils.UserObject;
...
public class ListUtilTest {
	...
	public void testDefaultList() {
		...
		assertEquals(defaultUserList,
				ListUtils.defaultIfNull(defaultUserList, nullList));
	...
	public void testLazyListWithTransformer() {
		...
		List<UserObject> lazyList = ListUtils
				.lazyList(new ArrayList<UserObject>(), transformer);
	...
	public void testLazyListWithFactory() {
		...
		List<UserObject> lazyList1 = ListUtils
				.lazyList(new ArrayList<UserObject>(), factory);
